...
{
    public abstract class Shopping_cartWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Shopping_cartWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Shopping_cartWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Shopping_cartDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Shopping_cartDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Shopping_cartDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Shopping_cartDbContext, Task<T>> func)
        {
            T result;
